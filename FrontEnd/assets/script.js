...
function affichageProjets(projetsFiltre) {
...
function affichageModeEdition() {
    ...
    bandeau.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
    ...
    modifProjets.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    const filtrehidden = document.querySelector(".filtre")
    filtrehidden.classList.add("hidden")
...
function suppressionModeEdition() {
    bandeau.classList.remove("bandeau")
}
